...
const uint16 Script::_freqTable[] = {
...
#ifdef GP32_PORT
const char *Splash::_splashFileName = "splash.gp32";
#elif DC_PORT
const char *Splash::_splashFileName = "splash.dc";
#endif

const char *Resource::_dataFileName = "data";

const char *Resource::_indexFileName = "index";

const uint16 Resource::_resDataSeqList[][4] = {
	{ 0x14, 0x15, 0x16, 0x00 }, // protection screens, not used anymore
...
const StrEntry Graphics::_stringsTable[] = {
