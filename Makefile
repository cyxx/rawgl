...
SRCS = aifcplayer.cpp bitmap.cpp file.cpp engine.cpp graphics.cpp graphics_gl.cpp script.cpp mixer.cpp pak.cpp resource.cpp resource_nth.cpp resource_win31.cpp resource_3do.cpp systemstub_ogl.cpp \
